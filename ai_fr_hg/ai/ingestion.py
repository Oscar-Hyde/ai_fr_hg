...
from ai_fr_hg.ai.readers.base import MissingDependency, coerce_warnings as __coerce_warnings
				...
				document.db_set(
					{
						...
						"error_type": None,
						"error_message": None,
						"extraction_warnings": json.dumps(__coerce_warnings(result.warnings, reader.label, filename), indent=2) if result.warnings else "[]",
					},
					update_modified=False,
				)
