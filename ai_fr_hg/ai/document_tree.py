...
Nested Set.  Frappe's native Tree View owns rendering and lazy expansion
(``ai_knowledge/doctype/ai_document/ai_document_tree.js``) while this service
owns permission-filtered reads and transactional mutations.  The
