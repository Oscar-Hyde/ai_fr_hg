...
from ai_fr_hg.ai.readers.base import StructuredWarning, coerce_warnings
...
def test_structured_warning_dict():
	sw = StructuredWarning(
		code="archive_member",
		category="archive",
		severity="warning",
		reader="DocxReader",
		source_file="a.docx",
		location="member word/document.xml",
		message="member too large",
		details={"size": 60000000},
	)
	d = sw.as_dict()
